...
<li class="comment" id="comment-<?php echo $model->id; ?>">
    <div class="comment-content" data-comment-content-id="<?php echo $model->id; ?>">
        <div class="comment-author-avatar">
			<?php //yii\helpers\VarDumper::dump('http://gallery/user/'.$model->author['avatar_filename'],10,true); ?>
            <?php echo Html::img(Yii::getAlias('@web').'/user/'.$model->author['avatar_filename'], ['alt' => $model->getAuthorName()]); ?>
